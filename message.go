...
// From set sender
func (m *Message) From(form string) *Message {
...
func (m *Message) SetBoundary(boundary string) *Message {
	m.boundary = boundary
	return m
}

// SetHeader sets a value to the given header field.
func (m *Message) SetHeader(field string, value ...string) *Message {
...
func (m *Message) SetHeaders(h map[string][]string) *Message {
	for k, v := range h {
		m.SetHeader(k, v...)
	}
	return m
